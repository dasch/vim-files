...
if !exists("b:ruby_no_expensive") && !exists("ruby_no_expensive")
  ...
  syn region rubyCurlyBlock   matchgroup=rubyCurlyBracket start="{" matchgroup=rubyCurlyBracket end="}" contains=TOP fold
...
hi def link rubyBlockParameterList	Delimiter
hi def link rubyArrayDelimiter		Delimiter
hi def link rubyCurlyBracket		String
