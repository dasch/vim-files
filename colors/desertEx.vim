...
hi Constant     guifg=SkyBlue         gui=none
" hi Identifier   guifg=Skyblue        gui=none
hi Identifier   guifg=gray80        gui=none
hi Function     guifg=gray80        gui=none
...
hi Type         guifg=lightgoldenrod2           gui=none
" hi Special      guifg=aquamarine2    gui=none
hi Special      guifg=lightgoldenrod2        gui=none
